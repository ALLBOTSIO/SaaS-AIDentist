...
const DSO = () => {
  return (
    <>
      <Helmet>
        <title>DSO Solutions | AIDENTIST</title>
        <meta name="description" content="Transform your dental service organization with AI-powered evaluation and automation. Enhance patient care, streamline operations, and boost efficiency across multiple locations." />
        <meta name="keywords" content="DSO solutions, dental AI evaluation, AI automation, dental practice management, multi-location practice assessment" />
        <meta property="og:title" content="DSO Solutions | AIDENTIST" />
        <meta property="og:description" content="Transform your dental service organization with AI-powered evaluation and automation. Enhance patient care, streamline operations, and boost efficiency across multiple locations." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://aidentist.com/customers/dso" />
      </Helmet>
